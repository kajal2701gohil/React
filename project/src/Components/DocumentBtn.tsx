...
interface Iprops {
  folders: Folder[];
  handleDocFolders: (fileName: string, selectFolder: string) => void;
}

const DocumentBtn: React.FC<Iprops> = ({ folders, handleDocFolders }) => {
  ...
  const handleDocData = () => {
    if (file && selectFolder) {
      ...
      handleDocFolders(fileName, selectFolder);
        ...
        >
          ...
          <div className="inline-flex flex-column gap-2">
            ...
            <Tree
              ...
              onNodeClick={(e) => setSelectFolder(e.node.key as string | null)}
            />
          </div>
